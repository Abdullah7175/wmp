...
// URL is read from environment variable for flexibility
const WHATSAPP_API_URL = process.env.WHATSAPP_API_URL || 'http://erp.rehmanigroup.com:8003/whatsapp.php';

// Secret key is hardcoded because Next.js cannot parse $ characters in .env files
// The $ character is interpreted as variable interpolation, causing the value to be truncated
// SECURITY NOTE: This token is hardcoded for operational necessity. Keep this file secure.
const WHATSAPP_SECRET_KEY = 'kw$0126001';

// Log initialization (for debugging)
console.log('[WhatsApp Service Init]', {
    apiUrl: WHATSAPP_API_URL,
    secretKeyConfigured: true,
    secretKeyLength: WHATSAPP_SECRET_KEY.length,
    note: 'Token is hardcoded (Next.js cannot parse $ in env vars)'
});
