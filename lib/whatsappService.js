...
// WhatsApp API secret key loaded securely from environment variable
...
if (process.env.WHATSAPP_DEBUG === 'true') {
    console.log('[WhatsApp Service Init]', {
        ...
        secretKeyConfigured: Boolean(WHATSAPP_SECRET_KEY),
        secretKeyLength: WHATSAPP_SECRET_KEY ? WHATSAPP_SECRET_KEY.length : 0,
    });
}
