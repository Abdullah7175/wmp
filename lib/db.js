...
const pool = new Pool({
  ...
  connectionTimeoutMillis: 60000, // Increased to 60 seconds for remote connections
  acquireTimeoutMillis: 60000, // Increased to 60 seconds for remote connections
  maxUses: 7500, // Close (and replace) a connection after it has been used 7500 times
  keepAlive: true, // Enable TCP keep-alive
  keepAliveInitialDelayMillis: 0, // Start keep-alive immediately
  statement_timeout: 120000, // Increased statement timeout to 2 minutes
  query_timeout: 120000, // Increased query timeout to 2 minutes
