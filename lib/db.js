...
const pool = new Pool({
  ...
  max: 20, // Increased pool size for better handling of concurrent uploads
  idleTimeoutMillis: 600000, // Close idle clients after 10 minutes
  connectionTimeoutMillis: 120000, // Increased to 2 minutes for large file uploads
  acquireTimeoutMillis: 120000, // Increased to 2 minutes for large file uploads
  maxUses: 10000, // Increased max uses for better connection reuse
  keepAlive: true, // Enable TCP keep-alive
  keepAliveInitialDelayMillis: 0, // Start keep-alive immediately
  statement_timeout: 300000, // Increased statement timeout to 5 minutes for large operations
  query_timeout: 300000, // Increased query timeout to 5 minutes for large operations
  // Additional options for remote connections and large file handling
  application_name: 'wmp-app-large-uploads',
  tcp_keepalives_idle: 600,
  tcp_keepalives_interval: 30,
  tcp_keepalives_count: 3,
  // Additional settings for handling large file uploads
  allowExitOnIdle: false, // Keep connections alive during uploads
