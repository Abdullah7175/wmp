...
export default function TownReportPage() {
    ...
    const [natureOptions] = useState([
        ...
        { id: 'Provide n Fixing', name: 'Provide n Fixing' },
        ...
        { id: 'Repairing/Replacement', name: 'Repairing/Replacement' },
        { id: 'Desilting', name: 'Desilting' },
    ...
    const handleGenerate = async () => {
        setLoading(true);
        try {
            const response = await fetch('/api/dashboard/reports/town', {
                method: 'POST',
                ...
                body: JSON.stringify({
                    ...
                    dateTo,
                    showWorkType,
                    showNatureOfWork, // New
                    towns: selectedTowns,
                    workTypes: selectedWorkTypes,
                    naturesOfWork: showNatureOfWork ? selectedNatures : [] // New
                })
            });
            ...
            a.href = url;
            a.download = `Town_Report_${new Date().toISOString().split('T')[0]}.pdf`;
            a.click();
        } catch (error) {
    ...
    return (
        <div className="p-6 max-w-5xl mx-auto">
            <h1 className="text-2xl font-bold mb-6 flex items-center gap-2 text-blue-950">
                <MapPin className="text-blue-600" /> Town-wise Report Generation
            </h1>
                ...
                <Card>
                    ...
                    <CardContent className="pt-6">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {renderFilterList("Select Towns", townOptions, selectedTowns, setSelectedTowns, 'town')}
