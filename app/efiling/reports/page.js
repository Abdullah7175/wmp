    ...
    const reportCards = [
        {
            ...
            description: "View file status distribution and trends",
            icon: <FileText className="w-8 h-8 text-blue-600" />,
            href: "/efiling/reports/file-status",
            color: "bg-blue-50 border-blue-200"
        },
        {
            title: "Department Report",
            description: "Analyze department-wise file distribution",
            icon: <Building2 className="w-8 h-8 text-green-600" />,
            href: "/efiling/reports/department",
        ...
        },
        {
            ...
            href: "/efiling/reports/user-activity",
            color: "bg-purple-50 border-purple-200"
        },
        {
            title: "Timeline Report",
            description: "View file processing timelines",
            icon: <Calendar className="w-8 h-8 text-orange-600" />,
            href: "/efiling/reports/timeline",
    ...
    return (
        <div className="container mx-auto px-4 py-6">
            <div className="mb-8">
                ...
                <p className="text-gray-600">Comprehensive reports and analytics for the E-Filing system</p>
            </div>
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-orange-600">Pending Files</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <Button 
                                ...
                                onClick={() => router.push('/efiling/reports/file-status')}
                            >
                            ...
                            <Button 
                                variant="outline" 
                                className="h-20 flex flex-col items-center justify-center"
                                onClick={() => router.push('/efiling/reports/department')}
                            >
                            ...
                            <Button 
                                variant="outline" 
                                className="h-20 flex flex-col items-center justify-center"
                                onClick={() => router.push('/efiling/reports/user-activity')}
                            >
