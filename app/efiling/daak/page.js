...
export default function DaakPage() {
    ...
    useEffect(() => {
        fetchCategories();
        fetchDaak();
    }, [activeTab, statusFilter, categoryFilter, currentPage]);
        ...
        <div className="container mx-auto p-6 space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">View and manage all daak</p>
                </div>
                <Button onClick={() => router.push("/efiling/daak/new")}>
                ...
                <CardHeader>
                    <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
                        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full md:w-auto">
                            <TabsList>
                                <TabsTrigger value="all">All Daak</TabsTrigger>
                                ...
                                <TableBody>
                                    {filteredDaak.map((item) => (
                                        <TableRow key={item.id}>
                                            ...
                                            <TableCell>
                                                <div className="flex items-center gap-1">
                                                    {item.acknowledged_count || 0} / {item.recipient_count || 0}
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                            ...
                                            <TableCell>
                                                <Button
                                                    ...
                                                    size="sm"
                                                    onClick={() =>
                                                        router.push(`/efiling/daak/${item.id}`)
                                                    }
                                                >
