...
export default function CreateDaakCategoryPage() {
    ...
    return (
        <div className="container mx-auto px-4 py-6 max-w-4xl">
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h1 className="text-3xl font-bold">Create Daak Category</h1>
                    <p className="text-gray-600 mt-1">Create a new category for daak/letters</p>
                </div>
            </div>
