...
export default function CeLayoutClient({ children }) {
  const [sidebarOpen, setSidebarOpen] = useState(false);

  return (
    <div className="min-h-screen bg-gray-50">
      {/* Mobile sidebar */}
      <CeSidebar isOpen={sidebarOpen} onClose={() => setSidebarOpen(false)} />
      ...
      <div className="lg:pl-64">
        ...
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8 lg:hidden">
          ...
          <div className="flex-1 text-sm font-semibold leading-6 text-gray-900">CE Portal</div>
        </div>
